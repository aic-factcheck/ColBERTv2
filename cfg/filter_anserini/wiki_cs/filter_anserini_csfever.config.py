...
def config():
    ...
    SRC_PREDICTIONS_ROOT = Path(CORPUS_ROOT, "colbertv2/qacg/predictions/csfever/bert-base-multilingual-cased/nway32_anserini_231028_093104/colbert-best_eval/2bits")
    ...
    NOTE = f"Predictions on QACG test data for CsFEVER trained ColBERTv2 filtered by Anserini."
