...
def config():
    ...
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_shuf_231028_163128/colbert-best_eval")
    ...
    PREDICTIONS_ROOT = Path(COLBERT_ROOT, "predictions", TEST_NAME, INDEX_NAME, "test")
