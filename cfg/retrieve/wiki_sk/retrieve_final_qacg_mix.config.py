...
def config():
    ...
    CHECKPOINT_NAME = Path("cs_en_pl_sk", MODEL_NAME, "nway32_anserini_balanced_shuf_231029_200439/colbert-best_eval")
    ...
    NOTE = f"ColBERTv2 QACG-MIX tested on QACG-SK, Anserini with evidence."
