...
def config():
    ...
    ER_CHECKPOINT_NAME = Path(ER_MODEL_NAME, "nway32_anserini_balanced_230910_095401/colbert")
    ...
    NOTE = f"Predictions on QACG test data for QACG trained ColBERTv2 reranked by NLI model."
