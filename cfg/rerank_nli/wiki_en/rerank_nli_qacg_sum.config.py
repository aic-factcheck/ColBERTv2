...
def config():
    ...
    ER_CHECKPOINT_NAME = Path("sum_cs_en_pl_sk", ER_MODEL_NAME, "nway32_anserini_balanced_shuf_231029_200426/colbert-best_eval")
    ...
    NOTE = f"Predictions on QACG test data for QACG-SUM trained ColBERTv2 reranked by NLI model."
