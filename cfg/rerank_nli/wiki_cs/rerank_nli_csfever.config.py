...
def config():
    ...
    ER_CHECKPOINT_NAME = Path(ER_MODEL_NAME, "nway32_anserini_231028_093104/colbert-best_eval")
    ...
    NOTE = f"Predictions on QACG test data for CsFEVER trained ColBERTv2 reranked by NLI model."
