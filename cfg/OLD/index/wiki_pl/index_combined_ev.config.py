...
def config():
    ...
    COLBERT_ROOT = Path("/mnt/data/factcheck/wiki/pl/20230801/colbertv2", TRAIN_DATA)
    ...
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231026_113625/colbert")
    ...
    NOTE = "QACG-based ColBERT index. Model trained on cs_en_pl_sk combined data, Anserini with evidence."
