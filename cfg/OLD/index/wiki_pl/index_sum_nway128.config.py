...
def config():
    ...
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway128_anserini_balanced_230918_110538/colbert")
    ...
    NOTE = "QACG-based ColBERT index. Model trained on sum_cs_en_pl_sk summed data."
