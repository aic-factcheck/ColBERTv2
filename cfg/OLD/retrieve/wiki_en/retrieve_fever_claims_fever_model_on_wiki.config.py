...
def config():
    ...
    CHECKPOINT_NAME = Path("cs_en_pl_sk", MODEL_NAME, "nway32_anserini_balanced_230914_121104/colbert")

    assert False, "TODO: NOT INDEXED YET !!!!!!!!!"
    INDEX_BITS = 2
    ...
    NOTE = f"Predictions on combined languages EnFEVER test data claims on WIKI-EN corpus for EnFEVER trained ColBERTv2."
