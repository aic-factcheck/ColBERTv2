...
def config():
    ...
    CHECKPOINT_NAME = Path("cs_en_pl_sk", MODEL_NAME, "nway32_anserini_balanced_230914_121104/colbert") # QACG
    ...
    NOTE = f"Predictions on EnFEVER test data claims on WIKI-EN corpus for combined languages QACG trained ColBERTv2 model."
