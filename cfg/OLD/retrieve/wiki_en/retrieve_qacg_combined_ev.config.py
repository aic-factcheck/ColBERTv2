...
def config():
    ...
    CHECKPOINT_NAME = Path("cs_en_pl_sk", MODEL_NAME, "nway32_anserini_balanced_231026_113625/colbert") # QACG
    ...
    NOTE = f"Predictions on combined languages QACG test data for QACG trained ColBERTv2, Anserini with evidence."
