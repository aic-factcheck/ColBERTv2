...
def config():
    ...
    # CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231026_095854/colbert") # QACG

    # CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231027_164541/colbert-best_eval")
    # CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231027_192252/colbert-best_eval")
    # CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231027_173414/colbert-best_eval")
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231027_195117/colbert-best_eval")
