...
def config():
    ...
    CHECKPOINT_NAME = Path("cs_en_pl_sk", MODEL_NAME, "nway128_anserini_balanced_230917_104437/colbert") # QACG
    ...
    NOTE = f"Predictions on combined languages QACG test data for QACG trained ColBERTv2. NWAY 128."
