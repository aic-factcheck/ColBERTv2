...
def config():
    ...
    CHECKPOINT_NAME = Path("sum_cs_en_pl_sk", MODEL_NAME, "nway32_anserini_balanced_231026_115640/colbert") # QACG
    ...
    NOTE = f"Predictions on summed languages QACG test data for QACG trained ColBERTv2, Anserini with evidence."
