...
def config():
    ...
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway128_anserini_balanced_230917_104104/colbert") # QACG
    ...
    NOTE = f"Predictions on QACG test data for QACG trained ColBERTv2. NWAY 128."
