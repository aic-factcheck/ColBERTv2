...
def config():
    ...
    # CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_230909_221105/colbert") # QACG
    # CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231026_202052/colbert")
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_balanced_231026_202052/colbert-10000")
    ...
    NOTE = f"Predictions on QACG test data for QACG trained ColBERTv2."
