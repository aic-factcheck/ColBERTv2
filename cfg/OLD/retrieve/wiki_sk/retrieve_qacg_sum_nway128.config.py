...
def config():
    ...
    CHECKPOINT_NAME = Path("sum_cs_en_pl_sk", MODEL_NAME, "nway128_anserini_balanced_230918_110538/colbert")
    ...
    NOTE = f"Predictions on summed languages QACG test data for QACG trained ColBERTv2. NWAY 128."
