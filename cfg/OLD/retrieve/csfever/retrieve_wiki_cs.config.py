...
def config():
    ...
    COLBERT_ROOT = Path("/mnt/data/factcheck/wiki/cs/20230801/colbertv2/qacg")

    MODEL_NAME = "bert-base-multilingual-cased"
    MODEL_NAME = MODEL_NAME.replace("/", "_")
    CHECKPOINT_NAME = Path(MODEL_NAME, "nway32_anserini_230914_180628/colbert")
    ...
    NOTE = f"Predictions on QACG CS for CsFEVER LREV trained ColBERTv2."
