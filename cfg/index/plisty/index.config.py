...
def config():
    ...
    COLBERT_ROOT = Path("/mnt/data/newton/parlamentni_listy/factcheck/v1/colbertv2", TRAIN_DATA)
    ...
    NOTE = "QACG-based ColBERT index for Parlamentni listy. Model trained on CSNEWS."
